<script lang="ts">
	...
	import { getUserCredits, topUpUserCredits } from '$lib/apis/credits';
						...
						>
							<div class="py-2 w-full">
								...
								<button
									class="flex py-2.5 px-3.5 w-full hover:bg-gray-800 transition"
									on:click={async () => {
										let resp = await topUpUserCredits(localStorage.token);
								...
								>																
									...
									<div class=" self-center font-medium">Top Up</div>
								</button>								
							</div>
